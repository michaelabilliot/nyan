...
export const SKINS_DATA = [ 
    // MODIFIED: Added trailOrigin property to customize where the trail starts
    // trailOrigin: { x: pixels from left, y: pixels from top for vertical center }
    ...
    { id: 'mexinyan', name: 'Mexi Nyan', rebirthUnlock: 2, bonus: { type: 'global', value: 1.01 }, image: 'assets/cats/mexinyan.png', trail: 'assets/cats/mexinyan-slice.png', trailHeight: 160, description: '¡Fiesta en el espacio!', trailOrigin: { x: 70, y: 180 } },
    ...
    { id: 'nyandoge', name: 'Nyan Doge', rebirthUnlock: 3, bonus: { type: 'global', value: 1.015 }, image: 'assets/cats/nyandoge.png', trail: 'assets/cats/nyandoge-slice.png', trailHeight: 270, description: 'Such cat. Much space. Wow.', trailOrigin: { x: 100, y: 165 } },
    { id: 'nyaninja', name: 'Nyaninja', rebirthUnlock: 3, bonus: { type: 'global', value: 1.015 }, image: 'assets/cats/nyaninja.png', trail: 'assets/cats/nyaninja-slice.png', trailHeight: 150, description: 'Silent, deadly, and adorable.', trailOrigin: { x: 60, y: 80 } },
    { id: 'paddy', name: 'Paddy Nyan', rebirthUnlock: 3, bonus: { type: 'global', value: 1.015 }, image: 'assets/cats/paddy.png', trail: 'assets/cats/paddy-slice.png', trailHeight: 200, description: 'A lucky charm for your clicking adventure.', trailOrigin: { x: 80, y: 260 } },
    { id: 'pikanyan', name: 'Pikanyan', rebirthUnlock: 4, bonus: { type: 'global', value: 1.02 }, image: 'assets/cats/pikanyan.png', trail: 'assets/cats/pikanyan-slice.png', trailHeight: 200, description: 'I choose you, Nyan Cat!', trailOrigin: { x: 100, y: 155 } },
    ...
    { id: 'pusheen', name: 'Pusheen Cat', rebirthUnlock: 5, bonus: { type: 'global', value: 1.025 }, image: 'assets/cats/pusheen-cat.png', trail: 'assets/cats/pusheen-slice.png', trailHeight: 250, description: 'The famous cartoon cat takes to the stars.', trailOrigin: { x: 130, y: 165 } },
    ...
    { id: 'zombie', name: 'Zombie Nyan', rebirthUnlock: 7, bonus: { type: 'global', value: 1.035 }, image: 'assets/cats/zombie.png', trail: 'assets/cats/zombie-slice.png', trailHeight: 200, description: 'Braaaains... and poptarts.', trailOrigin: { x: 80, y: 135 } },
    { id: 'hd', name: 'HD Nyan', secretName: '??? Cat', rebirthUnlock: 8, bonus: { type: 'global', value: 1.05 }, image: 'assets/cats/hd-nyan-cat.png', trail: 'assets/cats/hd-nyan-slice.png', trailHeight: 400, description: 'Experience Nyan Cat in glorious high definition.', trailOrigin: { x: 130, y: 220 } },
